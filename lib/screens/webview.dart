...
class TestsWebView extends StatefulWidget {
  static const String id = 'webview_screen';

  const TestsWebView({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _TestsWebViewState createState() => new _TestsWebViewState();
}

class _TestsWebViewState extends State<TestsWebView> {
