...
class QuizBrain {
  ...
  List<Question> questions = [
    ...
    Question(questionText: 'As lives do grupo Favela Sem Corona ocorrem:',
        questionAnswer: 1,
        possibleAnswers: ['Às Segundas-feiras as 8:00 da manhã no canal do Facebook', 'Todas as Terças e Sextas-feiras às 19:00 no canal do Instagram', 'Eventualmente, conforme achamos necessário'],
        note: 'Nota: Todas as semanas, as Terças e as Sextas-Feiras às 19:00 na nossa página do Instagram trazemos a vocês os melhores experts e pessoas interessantes para engajarmos nossas comunidades para diminuir o impacto do COVID-19. Participe! '),
    Question(questionText: 'O coronavírus SARS-CoV-2 é um vírus novo, que apareceu pela primeira vez em dezembro de 2019, numa região da China. Isto significa que:',
        questionAnswer: 0,
        possibleAnswers: ['Como é novo, ainda estamos estudando o comportamento do vírus', 'Apesar de ser novo, já savemos tudo sobre o comportamento do vírus'],
    ...
    Question(questionText: 'Alguns vírus podem ser transmitidos por animais aos seres humanos',
        questionAnswer: 0,
        possibleAnswers: ['Sim', 'Não'],
        note: 'Nota: Existem vírus que podem ser transmitidos por animais domésticos aos seres humanos, como é o caso do da raiva. Mas, até agora nao se provou que o coronavírus SARS-CoV-2 possa ser transmitido pelos nossos animais domésticos.'),
